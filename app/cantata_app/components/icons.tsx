...
export const IconWalk = ({ size = 12, className }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox='0 0 24 24'
    ...
    className={className}
  >
    <path d='M13 4m-1.5 0a1.5 1.5 0 1 0 3 0a1.5 1.5 0 1 0 -3 0' />
    <path d='M7 21l3 -5' />
    <path d='M16 21l-2 -5l-3 -3l1 -5' />
    <path d='M8 9l4 -1l4 2' />
  </svg>
);

export const IconCup = ({ size = 18, className }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox='0 0 24 24'
    ...
    className={className}
  >
    <path d='M4 10h13v5a6 6 0 0 1 -6 6h-1a6 6 0 0 1 -6 -6z' />
    <path d='M17 10h1.5a2.5 2.5 0 0 1 0 5h-1.5' />
