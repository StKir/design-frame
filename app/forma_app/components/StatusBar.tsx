export const StatusBar = () => (
  <div className="flex h-11 items-end justify-between px-6 pb-1">
    <span className="text-[13px] font-semibold text-[#0A0A0A]">9:41</span>
    <div className="flex items-center gap-1">
      <svg width="16" height="12" viewBox="0 0 16 12" fill="none" aria-hidden="true">
        <rect x="0" y="6" width="3" height="6" rx="0.5" fill="#0A0A0A" />
        <rect x="4.5" y="4" width="3" height="8" rx="0.5" fill="#0A0A0A" />
        <rect x="9" y="2" width="3" height="10" rx="0.5" fill="#0A0A0A" />
        <rect x="13.5" y="0" width="2.5" height="12" rx="0.5" fill="#0A0A0A" />
      </svg>
      <svg width="15" height="12" viewBox="0 0 15 12" fill="none" aria-hidden="true">
        ...
        <path
          ...
          fill="#0A0A0A"
        />
        <circle cx="7.5" cy="10.5" r="1.5" fill="#0A0A0A" />
      </svg>
      <svg width="25" height="12" viewBox="0 0 25 12" fill="none" aria-hidden="true">
        <rect x="0.5" y="0.5" width="21" height="11" rx="2.5" stroke="#0A0A0A" strokeOpacity="0.35" />
        <rect x="2" y="2" width="16" height="8" rx="1.5" fill="#0A0A0A" />
        <path
